...
class CRM_Searchactiondesigner_Form_Task_Event extends CRM_Event_Form_Task {
  ...
  protected function setEntityShortName() {
    self::$entityShortname = 'CRM_Searchactiondesigner_Form_Task_Event';
  }
  ...
  public function postProcess() {
    ...
    CRM_Searchactiondesigner_Form_Task_Helper::postProcess($this->searchTaskId, $submittedValues, $this->_participantIds);
  }
