...
class CRM_Searchactiondesigner_Form_Task_Activity extends CRM_Activity_Form_Task {
  ...
  public function postProcess() {
    ...
    CRM_Searchactiondesigner_Form_Task_Helper::postProcess($this->searchTaskId, $submittedValues, $this->_activityHolderIds);
  }
