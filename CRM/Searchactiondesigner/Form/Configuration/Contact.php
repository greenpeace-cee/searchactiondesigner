...
class CRM_Searchactiondesigner_Form_Configuration_Contact implements CRM_Searchactiondesigner_Form_ConfigurationInterface {
  ...
  public function buildConfigurationForm(CRM_Core_Form $form, array $configuration): array {
    $summaryOptions = [
      'primaryActions' => E::ts('Show on contact summary'),
      'otherActions' => E::ts('Show on contact summary under Other Actions'),
    ];
    $form->add('select', 'summary', E::ts('Summary'), $summaryOptions, FALSE, array(
      'style' => 'min-width:250px',
      'class' => 'crm-select2 huge',
      'placeholder' => E::ts('- Do not show on Contact Summary -'),
    ));
