...
class CRM_Searchtaskbuilder_Mapping {
  ...
  public static function getFieldsForMapping($search_task_id, $id=null) {
    $actionProvider = searchtaskbuilder_get_action_provider();
    $return = array();
    $searchTask = civicrm_api3('SearchTask', 'getsingle', array('id' => $search_task_id));
    $return['id'] = CRM_Searchtaskbuilder_Type::getIdFieldTitle($searchTask['type']);
